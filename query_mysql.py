...
You will be given JSON string of a list of movies. 
Each movie has description item which you will use to explain why the description of the movie likely fits the prompt.
If it does not fits the prompt, you will write it as None.
The explanation should be one paragraph only.
The explanation should be stored in 'llm_summary' field.
...
Return the JSON string intact and do not modify the order of the element.
"""
